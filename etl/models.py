...
class InvoiceData(CPkModel):
    app_id = models.IntegerField(name="App ID")
    xref = models.IntegerField(null=False, name="Xref", editable=False, primary_key=True)
    settlement_date = models.DateField(null=False, name="Settlment Date")
    ...
    total_loan_amount = models.FloatField(null=False, name="Total Loan Amount", editable=False, primary_key=True)
    comission_rate = models.FloatField(null=False, name="Comission Rate")
    upfront = models.FloatField(name="Upfront")
    upfront_incl_gst = models.FloatField(name="Upload Incl GST")
